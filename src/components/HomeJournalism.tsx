...
import { HOME_JOURNALISM } from "@/data/home";
import {
  HOME_TYPE,
  HOME_CARD_MEDIA,
  HOME_CARD_MEDIA_IMG,
...
/** Journalism */
export function HomeJournalism() {
  return (
    <section
      id="journalism"
      aria-labelledby="journalism-heading"
